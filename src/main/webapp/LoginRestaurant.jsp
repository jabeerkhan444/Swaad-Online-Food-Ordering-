...
.item1 img {
 ...
 <body class="bright-mode"> <!-- Set initial mode -->
    <header>
     ...
     <div class="container">
     <h5>Hi <%= request.getAttribute("name") %>, What's on your mind ?<h5>
     ...
     <h4>Best Food in Bengaluru Restaurants</h4>
        <% int counter = 0; %>
        <div class="row">
            <!-- JSP Code -->
            <%
            ...
            %>
                ...
                <div class="item"> 
                    ...
                    <div class="text-container">
                        ...
                        <div class="eta-time text-left"><p><%= restaurant.getEta() + " mins" %></p></div>
 ...
 <script>
        ...
        darkModeToggle.addEventListener('click', function () {
            ...
            if (document.body.classList.contains('dark-mode')) {
                darkModeToggle.value = 'Bright Mode';
            } else {
                darkModeToggle.value = 'Dark Mode';
            }
        });
    </script>
</body>
